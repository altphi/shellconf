...
/***************************************************************************/
/* Global function to iterate over the properties of a callObjHandle. If the 
function is local to an Object, JavaScript actually creates an Object in the 
background. The prototype of that object is an Object (*Not a Function Object*), 
so that confuses the interpreter, throws exceptions and skip populating local objects.
Using a global function fixes that. Another advantage is perhaps no extra object created.
*/
