...
$blog_title = "beck.j38.net wiki";

# What's this blog's description (for outgoing RSS feed)?
$blog_description = "open source philology";
...
$static_dir = "/Library/WebServer/Documents/wiki.local/";

# What's my administrative password (you must set this for static rendering)?
$static_password = "static-please";
...
sub generate {
  ...
  unless (defined($skip) and $skip) {
    ...
    foreach my $path_file ( &$sort(\%f, \%others) ) {
      ...
      # increment counter for expand/collapse 
      $count +=1;
